...
//        	public Person(String name, int age, String job, Integer num, Date createTime, boolean aBoolean, Double aDouble) {
        ...
        //属性对应数组：
        String [] field = new String[]{"name", "age", "job", "num", "createTime", "aDouble", "aBoolean"};
        //列名title对应数组
        String [] colume =  new String[]{"姓名", "年龄", "职业", "数量", "创建时间", "double", "boolean"};
        XSSFWorkbook workbook = getWorkbook(list,field ,colume);
        if (workbook != null) {
            try {
